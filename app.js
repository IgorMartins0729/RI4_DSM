...
empresaTwitter.clientes.add(cliente1)
empresaTwitter.clientes.add(cliente2)
empresaTwitter.clientes.add(cliente3)
empresaTwitter.clientes.add(cliente4)
empresaTwitter.clientes.add(cliente5)

console.log(empresaTwitter.detalhes())
